...
- **Resiliencia**: Reintentos con Exponential Backoff (SSH) y Buffering en memoria (asyncio.Queue).
- **Observabilidad**: Exportador de métricas Prometheus (:8080/metrics) y Health Checks nativos.
