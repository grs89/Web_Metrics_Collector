...
- **Ventana**: Compara los últimos 5 minutos de tráfico contra las mismas ventanas de tiempo en semanas anteriores.
- **Alertas**: Genera advertencias si `Z > 3.0` (Tráfico inusual alto) o `Z < -3.0` (Caída inusual de tráfico).
